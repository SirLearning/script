...
#nohup java -cp ~/js/pop/src/ ssReads 1 cs.f1.fq.gz f1.14.fq cs.r2.fq.gz r2.14.fq 887 &
#nohup java -cp ~/js/pop/src/ ssReads 1 dtb.f1.fq.gz f1.16.fq dtb.r2.fq.gz r2.16.fq 1013 &
#nohup java -cp ~/js/pop/src/ ssReads 1 cs.f1.fq.gz f1.18.fq cs.r2.fq.gz r2.18.fq 1140 &
#nohup java -cp ~/js/pop/src/ ssReads 1 cs.f1.fq.gz f1.20.fq cs.r2.fq.gz r2.20.fq 1267 &
