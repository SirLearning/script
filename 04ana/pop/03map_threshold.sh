# nohup sh ~/scripts/05pop/03map_threshold.sh 2 1A &
bwa-mem2 mem -t 15 $2.known.fa ~/transposon/ABD/00data/03reads/f1.$1.fq.gz ~/transposon/ABD/00data/03reads/r2.$1.fq.gz | samtools view -S -b - > $1.raw.bam
