...
# split version
bwa-mem2 mem -t 15 1A.lib.fa ../f_10M.fq ../r_10M.fq | samtools view -S -b - > 1A.raw.bam
samtools sort -n -m 4G -@ 10 -o 1A.sort.bam -O bam 1A.raw.bam
samtools fixmate -@ 10 -m 1A.sort.bam 1A.fixmate.bam
samtools sort -m 4G -@ 10 -o 1A.fixmate.pos.bam -O bam 1A.fixmate.bam
samtools markdup -@ 10 -r 1A.fixmate.pos.bam 1A.rmdup.bam