...
Watkins_phenotype <- read_excel("D:\\Zheng\\Documents\\2_NBS\\Python\\script\\resources\\Watseq_phenotype_data\\Watkins_Collection_WGIN_WISP_DFW_watseq_phenotype_data_JIC.xlsx",
...
# related transposon (heading transposon & height)
attach(Watkins_phenotype)
