...
awk -F'\t' '$16=="DHH"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.DHH.dtb.txt
awk -F'\t' '$16=="DTA"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.DTA.dtb.txt
awk -F'\t' '$16=="DTC"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.DTC.dtb.txt
awk -F'\t' '$16=="DTH"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.DTH.dtb.txt
awk -F'\t' '$16=="DTM"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.DTM.dtb.txt
awk -F'\t' '$16=="DTT"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.DTT.dtb.txt
awk -F'\t' '$16=="RIJ"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.RIJ.dtb.txt
awk -F'\t' '$16=="RIL"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.RIL.dtb.txt
awk -F'\t' '$16=="RIR"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.RIR.dtb.txt
awk -F'\t' '$16=="RLC"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.RLC.dtb.txt
awk -F'\t' '$16=="RLG"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.RLG.dtb.txt
awk -F'\t' '$16=="RSX"' mod.edta.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -counts -F 0.5 > coverage.RSX.dtb.txt
