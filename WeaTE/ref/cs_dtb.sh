...
awk -F'\t' '$16=="DHH"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.DHH.dtb.txt
awk -F'\t' '$16=="DTA"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.DTA.dtb.txt
awk -F'\t' '$16=="DTC"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.DTC.dtb.txt
awk -F'\t' '$16=="DTH"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.DTH.dtb.txt
awk -F'\t' '$16=="DTM"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.DTM.dtb.txt
awk -F'\t' '$16=="DTT"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.DTT.dtb.txt
awk -F'\t' '$16=="RIJ"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.RIJ.dtb.txt
awk -F'\t' '$16=="RIL"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.RIL.dtb.txt
awk -F'\t' '$16=="RIR"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.RIR.dtb.txt
awk -F'\t' '$16=="RLC"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.RLC.dtb.txt
awk -F'\t' '$16=="RLG"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.RLG.dtb.txt
awk -F'\t' '$16=="RSX"' mod.cs.gff3 | bedtools coverage -a stats.dtb.bed6 -b - -mean -F 0.5 > coverage.RSX.dtb.txt
